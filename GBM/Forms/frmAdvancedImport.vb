...
Public Class frmAdvancedImport
    ...
    Private Sub SetForm()
        ...
        btnDetectSavedGames.Image = mgrResources.GetResource("Multi_Search", GetType(Image))
        ...
        oImageList.Images.Add(mgrResources.GetResource("frmAdvancedImport_New", GetType(Image)))
        oImageList.Images.Add(mgrResources.GetResource("frmAdvancedImport_Update", GetType(Image)))
        oImageList.Images.Add(mgrResources.GetResource("frmAdvancedImport_Ignored", GetType(Image)))
        oImageList.Images.Add(mgrResources.GetResource("frmAdvancedImport_Detected", GetType(Image)))
