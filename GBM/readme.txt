...
- Overhaul of the Game Manager interface (more details to come later)
- "Search" on the main window and "Quick Filter" on the Game Manager now supports searching by tag.
