...
- Game Backup Monitor is now built for .NET v4.8.1.
	- This change may affect users running GBM on legacy Windows versions or Linux distributions using old versions of Mono.
