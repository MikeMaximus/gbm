...
- Added "Detection Speed" option
	...
	- Changes how quickly GBM detects games, faster settings have a higher average CPU usage.
	- The average user will never need to adjust this setting, however it allows users monitoring hundreds or even thousands of games to greatly lower their average CPU usage.
